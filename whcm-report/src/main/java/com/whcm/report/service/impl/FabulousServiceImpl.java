...
public class FabulousServiceImpl implements IFabulousService
{
	...
	public Integer selectFabulousAndVotes(String wxUserOpenId) {
		return fabulousMapper.selectFabulousAndVotes(wxUserOpenId);
	}
	...
	public Integer selectFabulous(String wxUserOpenId) {
		return fabulousMapper.selectFabulous(wxUserOpenId);
	}

	@Override
	public Integer selectVotes(String wxUserOpenId) {
		return fabulousMapper.selectVotes(wxUserOpenId);
	}
}
